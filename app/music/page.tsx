export default function Music() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-10 text-[17px]">
      ...
      <h1 className="mt-6 text-5xl font-bold tracking-tight">Music</h1>
      ...
      <div className="mt-12 space-y-16">
        {releases.map((release) => (
          <article key={release.title} className="border-t border-neutral-700 pt-10">
            <h2 className="text-2xl font-bold tracking-tight text-white">{release.title}</h2>
            ...
            {release.image && (
              <div className="mt-8">
                <img
                  src={release.image}
                  alt={release.title}
                  className="h-64 w-64 border border-neutral-800 object-cover"
                />
              </div>
            )}
