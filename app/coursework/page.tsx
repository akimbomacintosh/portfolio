...
export default async function Coursework() {
  ...
  return (
    <>
      <section className="page-hero relative flex flex-col justify-between" style={{ minHeight: "clamp(400px,65vh,680px)", backgroundImage: "url('/images/videography/husky-stadium.jpg')", backgroundSize: "cover", backgroundPosition: "center", padding: "clamp(32px,5vh,60px) clamp(24px,5vw,80px)" }}>
